"""
Django settings for orange_api project.
...
SECRET_KEY = 'django-insecure-ci3rmag91oe8&xo)-@uzha)b^nd$hk8#vf-s9a5@q2oq&dz^*3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['api.orange.cn']
...
MIDDLEWARE = [
    ...
    'orange_api.middlewares.logs.LogMiddleware'
]

ROOT_URLCONF = 'orange_api.urls'
...
WSGI_APPLICATION = 'orange_api.wsgi.application'

# ASGI_APPLICATION = "orange_api.routing.application"
# # WebSocket
# CHANNEL_LAYERS = {
#     'default': {
...
LOGGING = {
    ...
    'handlers': {  # 日志的处理方式
        ...
        'file': {  # 文件中记录日志
            ...
            'filename': BASE_DIR.parent / "logs/orange.log",
...
REST_FRAMEWORK = {
    # 异常处理
    'EXCEPTION_HANDLER': 'orange_api.utils.exceptions.custom_exception_handler',
    #认证
